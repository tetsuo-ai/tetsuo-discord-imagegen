...
class ChannelPassAnimator:
    ...
    def interpolate_keyframes(self, keyframes: List[float], total_frames: int) -> List[float]:
    ...
    def create_channel_pass_frame(self, offset_values: Tuple[float, float]) -> Image.Image:
    ...
    def generate_frames(self, params: Dict[str, Any], num_frames: int = 60) -> Optional[Path]:
