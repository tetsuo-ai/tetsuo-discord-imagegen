...
def setup_test_environment():
    ...
    for subdir in ['basic', 'combinations', 'presets', 'points', 'animations', 'ascii', 'consciousness']:
...
def test_all_functionality():
    ...
    for test_name, params in combination_tests.items():
        try:
            ...
            for effect in ['rgb', 'color', 'glitch', 'chroma', 'scan', 'noise', 'energy', 'pulse', 'consciousness']:
                if effect in params:
    ...
    for anim_name, params in animation_tests.items():
        ...
        try:
            ...
            frames = animation_processor.generate_frames(params, num_frames=params.pop('frames', 15))
    ...
    with tempfile.NamedTemporaryFile(suffix='.db', delete=False) as tmp_db:
        ...
        try:
            ...
            effects_to_test = {
                ...
                'preset': EFFECT_PRESETS['cyberpunk']
            }
